...
function Header() {
    return (
        <header className='p-4 m-4 border border-2 border-gray-100 bg-blue-500 rounded-2xl pt-6' >
             <nav className='flex justify-between text-white' role='navigation'>
                 <ul className='flex justify-around gap-[40px]'>
                    <li><a href="#home" className='border border-2 border-black-500 p-2 m-2 rounded-xl hover hover:bg-white hover:text-blue-500 hover:border-gray-700 font-bold'>Home</a></li>
